...
const uchar aes_invsbox_r[16][16] = {
...
static void AddRoundKey(uchar state[][4], uint w[])
{
   uchar subkey[4];
...
{
   state[0][0] = aes_sbox_r[state[0][0] >> 4][state[0][0] & 0x0F];
   state[0][1] = aes_sbox_r[state[0][1] >> 4][state[0][1] & 0x0F];
   state[0][2] = aes_sbox_r[state[0][2] >> 4][state[0][2] & 0x0F];
   state[0][3] = aes_sbox_r[state[0][3] >> 4][state[0][3] & 0x0F];
   state[1][0] = aes_sbox_r[state[1][0] >> 4][state[1][0] & 0x0F];
   state[1][1] = aes_sbox_r[state[1][1] >> 4][state[1][1] & 0x0F];
   state[1][2] = aes_sbox_r[state[1][2] >> 4][state[1][2] & 0x0F];
   state[1][3] = aes_sbox_r[state[1][3] >> 4][state[1][3] & 0x0F];
   state[2][0] = aes_sbox_r[state[2][0] >> 4][state[2][0] & 0x0F];
   state[2][1] = aes_sbox_r[state[2][1] >> 4][state[2][1] & 0x0F];
   state[2][2] = aes_sbox_r[state[2][2] >> 4][state[2][2] & 0x0F];
   state[2][3] = aes_sbox_r[state[2][3] >> 4][state[2][3] & 0x0F];
   state[3][0] = aes_sbox_r[state[3][0] >> 4][state[3][0] & 0x0F];
   state[3][1] = aes_sbox_r[state[3][1] >> 4][state[3][1] & 0x0F];
   state[3][2] = aes_sbox_r[state[3][2] >> 4][state[3][2] & 0x0F];
   state[3][3] = aes_sbox_r[state[3][3] >> 4][state[3][3] & 0x0F];
}

static void InvSubBytes(uchar state[][4])
{
   state[0][0] = aes_invsbox_r[state[0][0] >> 4][state[0][0] & 0x0F];
   state[0][1] = aes_invsbox_r[state[0][1] >> 4][state[0][1] & 0x0F];
   state[0][2] = aes_invsbox_r[state[0][2] >> 4][state[0][2] & 0x0F];
   state[0][3] = aes_invsbox_r[state[0][3] >> 4][state[0][3] & 0x0F];
   state[1][0] = aes_invsbox_r[state[1][0] >> 4][state[1][0] & 0x0F];
   state[1][1] = aes_invsbox_r[state[1][1] >> 4][state[1][1] & 0x0F];
   state[1][2] = aes_invsbox_r[state[1][2] >> 4][state[1][2] & 0x0F];
   state[1][3] = aes_invsbox_r[state[1][3] >> 4][state[1][3] & 0x0F];
   state[2][0] = aes_invsbox_r[state[2][0] >> 4][state[2][0] & 0x0F];
   state[2][1] = aes_invsbox_r[state[2][1] >> 4][state[2][1] & 0x0F];
   state[2][2] = aes_invsbox_r[state[2][2] >> 4][state[2][2] & 0x0F];
   state[2][3] = aes_invsbox_r[state[2][3] >> 4][state[2][3] & 0x0F];
   state[3][0] = aes_invsbox_r[state[3][0] >> 4][state[3][0] & 0x0F];
   state[3][1] = aes_invsbox_r[state[3][1] >> 4][state[3][1] & 0x0F];
   state[3][2] = aes_invsbox_r[state[3][2] >> 4][state[3][2] & 0x0F];
   state[3][3] = aes_invsbox_r[state[3][3] >> 4][state[3][3] & 0x0F];
}
...
static void InvShiftRows(uchar state[][4])
{
   int t;
   // Shift right by 1
   t = state[1][3];
...
static void MixColumns(uchar state[][4])
{
   ...
   col[2] = state[2][0];
   col[3] = state[3][0];
   state[0][0] = gf_mul_r[col[0]][0];
   state[0][0] ^= gf_mul_r[col[1]][1];
   state[0][0] ^= col[2];
   state[0][0] ^= col[3];
   state[1][0] = col[0];
   state[1][0] ^= gf_mul_r[col[1]][0];
   state[1][0] ^= gf_mul_r[col[2]][1];
   state[1][0] ^= col[3];
   state[2][0] = col[0];
   state[2][0] ^= col[1];
   state[2][0] ^= gf_mul_r[col[2]][0];
   state[2][0] ^= gf_mul_r[col[3]][1];
   state[3][0] = gf_mul_r[col[0]][1];
   state[3][0] ^= col[1];
   state[3][0] ^= col[2];
   state[3][0] ^= gf_mul_r[col[3]][0];
   // Column 2
   col[0] = state[0][1];
   col[1] = state[1][1];
   col[2] = state[2][1];
   col[3] = state[3][1];
   state[0][1] = gf_mul_r[col[0]][0];
   state[0][1] ^= gf_mul_r[col[1]][1];
   state[0][1] ^= col[2];
   state[0][1] ^= col[3];
   state[1][1] = col[0];
   state[1][1] ^= gf_mul_r[col[1]][0];
   state[1][1] ^= gf_mul_r[col[2]][1];
   state[1][1] ^= col[3];
   state[2][1] = col[0];
   state[2][1] ^= col[1];
   state[2][1] ^= gf_mul_r[col[2]][0];
   state[2][1] ^= gf_mul_r[col[3]][1];
   state[3][1] = gf_mul_r[col[0]][1];
   state[3][1] ^= col[1];
   state[3][1] ^= col[2];
   state[3][1] ^= gf_mul_r[col[3]][0];
   // Column 3
   col[0] = state[0][2];
   col[1] = state[1][2];
   col[2] = state[2][2];
   col[3] = state[3][2];
   state[0][2] = gf_mul_r[col[0]][0];
   state[0][2] ^= gf_mul_r[col[1]][1];
   state[0][2] ^= col[2];
   state[0][2] ^= col[3];
   state[1][2] = col[0];
   state[1][2] ^= gf_mul_r[col[1]][0];
   state[1][2] ^= gf_mul_r[col[2]][1];
   state[1][2] ^= col[3];
   state[2][2] = col[0];
   state[2][2] ^= col[1];
   state[2][2] ^= gf_mul_r[col[2]][0];
   state[2][2] ^= gf_mul_r[col[3]][1];
   state[3][2] = gf_mul_r[col[0]][1];
   state[3][2] ^= col[1];
   state[3][2] ^= col[2];
   state[3][2] ^= gf_mul_r[col[3]][0];
   // Column 4
   col[0] = state[0][3];
   col[1] = state[1][3];
   col[2] = state[2][3];
   col[3] = state[3][3];
   state[0][3] = gf_mul_r[col[0]][0];
   state[0][3] ^= gf_mul_r[col[1]][1];
   state[0][3] ^= col[2];
   state[0][3] ^= col[3];
   state[1][3] = col[0];
   state[1][3] ^= gf_mul_r[col[1]][0];
   state[1][3] ^= gf_mul_r[col[2]][1];
   state[1][3] ^= col[3];
   state[2][3] = col[0];
   state[2][3] ^= col[1];
   state[2][3] ^= gf_mul_r[col[2]][0];
   state[2][3] ^= gf_mul_r[col[3]][1];
   state[3][3] = gf_mul_r[col[0]][1];
   state[3][3] ^= col[1];
   state[3][3] ^= col[2];
   state[3][3] ^= gf_mul_r[col[3]][0];
}

static void InvMixColumns(uchar state[][4])
{
   uchar col[4];
   // Column 1
   col[0] = state[0][0];
   ...
   col[2] = state[2][0];
   col[3] = state[3][0];
   state[0][0] = gf_mul_r[col[0]][5];
   state[0][0] ^= gf_mul_r[col[1]][3];
   state[0][0] ^= gf_mul_r[col[2]][4];
   state[0][0] ^= gf_mul_r[col[3]][2];
   state[1][0] = gf_mul_r[col[0]][2];
   state[1][0] ^= gf_mul_r[col[1]][5];
   state[1][0] ^= gf_mul_r[col[2]][3];
   state[1][0] ^= gf_mul_r[col[3]][4];
   state[2][0] = gf_mul_r[col[0]][4];
   state[2][0] ^= gf_mul_r[col[1]][2];
   state[2][0] ^= gf_mul_r[col[2]][5];
   state[2][0] ^= gf_mul_r[col[3]][3];
   state[3][0] = gf_mul_r[col[0]][3];
   state[3][0] ^= gf_mul_r[col[1]][4];
   state[3][0] ^= gf_mul_r[col[2]][2];
   state[3][0] ^= gf_mul_r[col[3]][5];
   // Column 2
   col[0] = state[0][1];
   col[1] = state[1][1];
   col[2] = state[2][1];
   col[3] = state[3][1];
   state[0][1] = gf_mul_r[col[0]][5];
   state[0][1] ^= gf_mul_r[col[1]][3];
   state[0][1] ^= gf_mul_r[col[2]][4];
   state[0][1] ^= gf_mul_r[col[3]][2];
   state[1][1] = gf_mul_r[col[0]][2];
   state[1][1] ^= gf_mul_r[col[1]][5];
   state[1][1] ^= gf_mul_r[col[2]][3];
   state[1][1] ^= gf_mul_r[col[3]][4];
   state[2][1] = gf_mul_r[col[0]][4];
   state[2][1] ^= gf_mul_r[col[1]][2];
   state[2][1] ^= gf_mul_r[col[2]][5];
   state[2][1] ^= gf_mul_r[col[3]][3];
   state[3][1] = gf_mul_r[col[0]][3];
   state[3][1] ^= gf_mul_r[col[1]][4];
   state[3][1] ^= gf_mul_r[col[2]][2];
   state[3][1] ^= gf_mul_r[col[3]][5];
   // Column 3
   col[0] = state[0][2];
   col[1] = state[1][2];
   col[2] = state[2][2];
   col[3] = state[3][2];
   state[0][2] = gf_mul_r[col[0]][5];
   state[0][2] ^= gf_mul_r[col[1]][3];
   state[0][2] ^= gf_mul_r[col[2]][4];
   state[0][2] ^= gf_mul_r[col[3]][2];
   state[1][2] = gf_mul_r[col[0]][2];
   state[1][2] ^= gf_mul_r[col[1]][5];
   state[1][2] ^= gf_mul_r[col[2]][3];
   state[1][2] ^= gf_mul_r[col[3]][4];
   state[2][2] = gf_mul_r[col[0]][4];
   state[2][2] ^= gf_mul_r[col[1]][2];
   state[2][2] ^= gf_mul_r[col[2]][5];
   state[2][2] ^= gf_mul_r[col[3]][3];
   state[3][2] = gf_mul_r[col[0]][3];
   state[3][2] ^= gf_mul_r[col[1]][4];
   state[3][2] ^= gf_mul_r[col[2]][2];
   state[3][2] ^= gf_mul_r[col[3]][5];
   // Column 4
   col[0] = state[0][3];
   col[1] = state[1][3];
   col[2] = state[2][3];
   col[3] = state[3][3];
   state[0][3] = gf_mul_r[col[0]][5];
   state[0][3] ^= gf_mul_r[col[1]][3];
   state[0][3] ^= gf_mul_r[col[2]][4];
   state[0][3] ^= gf_mul_r[col[3]][2];
   state[1][3] = gf_mul_r[col[0]][2];
   state[1][3] ^= gf_mul_r[col[1]][5];
   state[1][3] ^= gf_mul_r[col[2]][3];
   state[1][3] ^= gf_mul_r[col[3]][4];
   state[2][3] = gf_mul_r[col[0]][4];
   state[2][3] ^= gf_mul_r[col[1]][2];
   state[2][3] ^= gf_mul_r[col[2]][5];
   state[2][3] ^= gf_mul_r[col[3]][3];
   state[3][3] = gf_mul_r[col[0]][3];
   state[3][3] ^= gf_mul_r[col[1]][4];
   state[3][3] ^= gf_mul_r[col[2]][2];
   state[3][3] ^= gf_mul_r[col[3]][5];
}
...
static uint SubWord(uint word)
{
   ...
   result = (int)aes_sbox_r[(word >> 4) & 0x0000000F][word & 0x0000000F];
   result += (int)aes_sbox_r[(word >> 12) & 0x0000000F][(word >> 8) & 0x0000000F] << 8;
   result += (int)aes_sbox_r[(word >> 20) & 0x0000000F][(word >> 16) & 0x0000000F] << 16;
   result += (int)aes_sbox_r[(word >> 28) & 0x0000000F][(word >> 24) & 0x0000000F] << 24;
   return(result);
}
...
static void KeyExpansion(uchar key[], uint w[], int keysize)
{
   int Nb=4,Nr,Nk,idx;
...
static void aes_encrypt(uchar in[], uchar out[], uint key[], int keysize)
{
   uchar state[4][4];
...
static void aes_decrypt(uchar in[], uchar out[], uint key[], int keysize)
{
   uchar state[4][4];
